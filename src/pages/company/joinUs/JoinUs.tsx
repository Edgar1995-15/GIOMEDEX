    ...
    <div className="w-full flex justify-center bg-gradient-to-r from-teal-600 via-teal-800 to-indigo-800">
      <div className="px-[127px] pt-14 max-w-[1440px]">
        ...
        <div className="mt-6 bg-opacity-90 font-[500] text-white">
          ...
          <Typography content={data.joinUs.subContent} color='text-white' className='mt-6 text-justify' />
        </div>
        <div className="mt-9 flex justify-between w-full gap-11">
          <div className="max-w-[364px]">
            ...
            <Typography content={data.benefits.content} className='mt-4 text-justify' color='text-white' />
          </div>
          <div className="max-w-[364px] mt-10">
            ...
            <Typography content={data.growth.content} className='mt-4 pb-14 text-justify' color='text-white' />
          </div>
          <div className="max-w-[364px]">
            <div className="flex items-center gap-2">
              <Icon name="time" />
            ...
            <Typography content={data.development.content} color='text-white' className='mt-4 text-justify' />
          </div>
        </div>
      </div>
    </div>
