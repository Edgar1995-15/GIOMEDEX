    ...
    <div className="flex h-[333px] w-full justify-center bg-gradient-to-br from-[#009462] to-[#3B579D]">
      <div className="container mt-9 flex justify-between ml-32 max-w-[1440px]">
        <div className="max-w-[526px]">
          ...
          <Typography content={data.mission.content} className='mt-4 text-white leading-6 text-justify' />
        </div>
        <div className="max-w-[47%] pr-[128px]">
          ...
          <Typography content={data.vision.content} className='mt-4 text-white left-6 text-justify' />
        </div>
      </div>
    </div>
  );
