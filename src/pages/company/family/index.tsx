...
const Family: FC = () => {
  ...
  return (
    <div className="m-auto mt-14 flex w-full max-w-[1440px] flex-col mobileMax:mt-9 mobileMax:max-w-[324px]">
      <div className="max-w-[90%] pl-[133px] mobileMax:pl-[18px]">
        <Typography
        ...
        <Typography
          ...
          size="text-[18px]"
          className="mt-3 !font-[500] mobileMax:mt-0"
        />
        <Typography
      ...
      <div className="mt-9 flex justify-center gap-9 mobileMax:pb-9">
        <Card
          ...
          className={`${activeTab === 1 ? "" : "mobileMax:hidden"}`}
        />
        <Card
          ...
          className={`mt-9 pb-14 ${activeTab === 2 ? "" : "mobileMax:hidden"}`}
        />
        <Card
          ...
          className={`${activeTab === 3 ? "" : "mobileMax:hidden"}`}
        />
      </div>
      <div className="m-auto my-9 hidden gap-2 mobileMax:flex">
        <div
