...
const Hero = () => {
  ...
  return (
    <div
      className="hidden h-[382px] w-full bg-cover bg-center bg-no-repeat md:block"
      style={{
        backgroundImage: 'url("/images/quality-policy/hero-bg.png")'
      }}
    >
      <div className="mx-auto flex h-full max-w-desktop flex-col px-32 py-[100px]">
        <Typography
